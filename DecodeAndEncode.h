...
public:
    ...
    void UpdateRemainderInBytes(std::ofstream& archive, std::vector<bool>& remainder_in_bytes, bool is_it_encode_process, bool is_it_end);
    ...
    void AddDecodedBitsToString(std::vector<bool>& decoded_bits, std::string& string_with_decoded_bytes, std::vector<bool>& remainder_in_bytes, bool is_it_end);
    void AddDecodedBitsToFile(std::vector<bool>& decoded_bits, std::ofstream& file, std::vector<bool>& remainder_in_bytes, bool is_it_end);
    void AddDecodedBitsToSizeT(std::vector<bool>& decoded_bits, size_t& object_len, std::vector<bool>& remainder_in_bytes, uint8_t& insertable_idx, bool is_it_end);
